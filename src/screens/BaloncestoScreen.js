...
const FutbolScreen = () => {
  ...
  useEffect(() => {
    const fetchOptions = async () => {
      try {
        const optionsCollection = collection(db, 'Baloncesto');
        ...
        console.error('Error al obtener las opciones de Baloncesto: ', error);
      }
    };
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.subtitle}>Elige una opción de Baloncesto</Text>
